...
1.  **Script**: Donde puedes escribir y guardar tu código R.
2.  **Console**: Donde puedes ejecutar comandos de R directamente.
...
Para crear un proyecto en R, puedes seguir estos pasos en RStudio:
...
4.  Luego, puedes especificar la ubicación del directorio y el nombre
    del proyecto.
...
6.  En el campo "Project directory name" (Nombre del directorio del
    proyecto), puedes especificar el nombre de la carpeta local donde se
...
Un "chunk" es un bloque de código R que puedes ejecutar en un documento
R Markdown. Puedes insertar un chunk utilizando tres comillas invertidas
...
valores del mismo tipo. Puedes crear un vector utilizando la función
`c()`.
...
específicas. R tiene muchas funciones incorporadas y también puedes
...
adicionales que extienden las capacidades de R. Puedes instalar y cargar
